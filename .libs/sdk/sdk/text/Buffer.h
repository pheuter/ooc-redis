...
#define Buffer_new_withContent(data) (void*) text_Buffer__Buffer_new_withContent((data))
#define Buffer_init_withContent(_this_, data) text_Buffer__Buffer_init_withContent((void*) (_this_), (data))
...
#define BufferReader_hasNext(_this_) text_Buffer__BufferReader_hasNext((void*) (_this_))
