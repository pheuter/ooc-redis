...
typedef lang_types__Bool (*__FUNC___K_K_K_Bool)(lang_types__Class*, uint8_t*, uint8_t*);

#endif


#ifndef __FUNC___K_K_UInt__DEFINE
#define __FUNC___K_K_UInt__DEFINE

typedef lang_types__UInt (*__FUNC___K_K_UInt)(lang_types__Class*, uint8_t*);
...
typedef void (*__FUNC___K_V)(uint8_t*, uint8_t*);
...
structs_HashMap__HashMap* structs_HashMap__HashMap_new_withCapacity(lang_types__Class* K, lang_types__Class* V, lang_types__Int capaArg);
void structs_HashMap__HashMap_init_withCapacity(structs_HashMap__HashMap* this, lang_types__Int capaArg);
...
lang_types__Bool structs_HashMap__HashMap_getEntryForHash(structs_HashMap__HashMap* this, uint8_t* key, lang_types__UInt hash, structs_HashMap__HashEntry* result);
lang_types__Bool structs_HashMap__HashMap_getEntryForHash_impl(structs_HashMap__HashMap* this, uint8_t* key, lang_types__UInt hash, structs_HashMap__HashEntry* result);
...
lang_types__Bool structs_HashMap__HashMap_isEmpty(structs_HashMap__HashMap* this);
lang_types__Bool structs_HashMap__HashMap_isEmpty_impl(structs_HashMap__HashMap* this);
lang_types__Bool structs_HashMap__HashMap_contains(structs_HashMap__HashMap* this, uint8_t* key);
lang_types__Bool structs_HashMap__HashMap_contains_impl(structs_HashMap__HashMap* this, uint8_t* key);
...
lang_types__Bool structs_HashMap__HashMap_resize(structs_HashMap__HashMap* this, lang_types__Int _capacity);
lang_types__Bool structs_HashMap__HashMap_resize_impl(structs_HashMap__HashMap* this, lang_types__Int _capacity);
lang_types__BackIterator* structs_HashMap__HashMap_iterator(structs_HashMap__HashMap* this);
lang_types__BackIterator* structs_HashMap__HashMap_iterator_impl(structs_HashMap__HashMap* this);
lang_types__BackIterator* structs_HashMap__HashMap_backIterator(structs_HashMap__HashMap* this);
lang_types__BackIterator* structs_HashMap__HashMap_backIterator_impl(structs_HashMap__HashMap* this);
...
lang_types__Int structs_HashMap__HashMap_size(structs_HashMap__HashMap* this);
lang_types__Int structs_HashMap__HashMap_size_impl(structs_HashMap__HashMap* this);
...
void structs_HashMap__HashMap_each(structs_HashMap__HashMap* this, __FUNC___K_V f);
void structs_HashMap__HashMap_each_impl(structs_HashMap__HashMap* this, __FUNC___K_V f);
...
lang_types__Bool structs_HashMap__HashMapValueIterator_hasNext(structs_HashMap__HashMapValueIterator* this);
lang_types__Bool structs_HashMap__HashMapValueIterator_hasNext_impl(structs_HashMap__HashMapValueIterator* this);
void structs_HashMap__HashMapValueIterator_next(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn31);
void structs_HashMap__HashMapValueIterator_next_impl(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn31);
lang_types__Bool structs_HashMap__HashMapValueIterator_hasPrev(structs_HashMap__HashMapValueIterator* this);
lang_types__Bool structs_HashMap__HashMapValueIterator_hasPrev_impl(structs_HashMap__HashMapValueIterator* this);
void structs_HashMap__HashMapValueIterator_prev(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn32);
void structs_HashMap__HashMapValueIterator_prev_impl(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn32);
...
lang_types__UInt structs_HashMap__intHash(lang_types__Class* K, uint8_t* key);
lang_types__UInt structs_HashMap__pointerHash(lang_types__Class* K, uint8_t* key);
lang_types__UInt structs_HashMap__charHash(lang_types__Class* K, uint8_t* key);
lang_types__UInt structs_HashMap__murmurHash(lang_types__Class* K, uint8_t* keyTagazok);
lang_types__UInt structs_HashMap__ac_X31_hash(lang_types__Class* K, uint8_t* key);
__FUNC___T_T_T_Bool structs_HashMap__getStandardEquals(lang_types__Class* T);
void structs_HashMap____OP_IDX_HashMap_K__V(uint8_t* __genericReturn34, lang_types__Class* K, lang_types__Class* V, structs_HashMap__HashMap* map, uint8_t* key);
