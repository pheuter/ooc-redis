...
struct _structs_HashMap__HashMap {
    ...
    __FUNC___K_K_K_Bool keyEquals;
    __FUNC___K_K_UInt hashKey;
...
struct _structs_HashMap__HashMapClass {
    ...
    structs_HashMap__HashMap* (*new_withCapacity)(lang_types__Class*, lang_types__Class*, lang_types__Int);
    void (*init_withCapacity)(structs_HashMap__HashMap*, lang_types__Int);
    lang_types__Bool (*getEntry)(structs_HashMap__HashMap*, uint8_t*, structs_HashMap__HashEntry*);
    lang_types__Bool (*getEntryForHash)(structs_HashMap__HashMap*, uint8_t*, lang_types__UInt, structs_HashMap__HashEntry*);
    ...
    lang_types__Bool (*isEmpty)(structs_HashMap__HashMap*);
    lang_types__Bool (*contains)(structs_HashMap__HashMap*, uint8_t*);
    lang_types__Bool (*remove)(structs_HashMap__HashMap*, uint8_t*);
    lang_types__Bool (*resize)(structs_HashMap__HashMap*, lang_types__Int);
    void (*clear)(structs_HashMap__HashMap*);
    lang_types__Int (*size)(structs_HashMap__HashMap*);
    structs_ArrayList__ArrayList* (*getKeys)(structs_HashMap__HashMap*);
    void (*each)(structs_HashMap__HashMap*, __FUNC___K_V);
};
...
struct _structs_HashMap__HashMapValueIteratorClass {
    ...
    lang_types__Bool (*hasNext)(structs_HashMap__HashMapValueIterator*);
...
#define getStandardEquals(T, T) (void*) structs_HashMap__getStandardEquals((T), (void*) (T))
...
#define HashMap_isEmpty(_this_) structs_HashMap__HashMap_isEmpty((void*) (_this_))
#define HashMap_contains(_this_, key) structs_HashMap__HashMap_contains((void*) (_this_), (key))
...
#define HashMap_each(_this_, f) structs_HashMap__HashMap_each((void*) (_this_), (void*) (f))
...
#define HashMapValueIterator_hasNext(_this_) structs_HashMap__HashMapValueIterator_hasNext((void*) (_this_))
#define HashMapValueIterator_next(_this_, __genericReturn31) structs_HashMap__HashMapValueIterator_next((void*) (_this_), (__genericReturn31))
#define HashMapValueIterator_hasPrev(_this_) structs_HashMap__HashMapValueIterator_hasPrev((void*) (_this_))
#define HashMapValueIterator_prev(_this_, __genericReturn32) structs_HashMap__HashMapValueIterator_prev((void*) (_this_), (__genericReturn32))
