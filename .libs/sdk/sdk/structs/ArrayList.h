...
struct _structs_ArrayList__ArrayListClass {
    ...
    void (*sort)(structs_ArrayList__ArrayList*, __FUNC___T_T_Bool);
    ...
    lang_types__BackIterator* (*backIterator)(structs_ArrayList__ArrayList*);
};
...
struct _structs_ArrayList__ArrayListIteratorClass {
    ...
    lang_types__Bool (*hasNext)(structs_ArrayList__ArrayListIterator*);
...
#define ArrayList_sort(_this_, greaterThan) structs_ArrayList__ArrayList_sort((void*) (_this_), (void*) (greaterThan))
...
#define ArrayListIterator_hasNext(_this_) structs_ArrayList__ArrayListIterator_hasNext((void*) (_this_))
...
#define ArrayListIterator_hasPrev(_this_) structs_ArrayList__ArrayListIterator_hasPrev((void*) (_this_))
