...
struct _io_Writer__WriterClass {
    ...
    lang_types__SizeT (*write)(io_Writer__Writer*, lang_types__Char*, lang_types__SizeT);
    lang_types__SizeT (*write_implicitLength)(io_Writer__Writer*, lang_types__String);
    void (*writef)(io_Writer__Writer*, lang_types__String, ...);
    void (*vwritef)(io_Writer__Writer*, lang_types__String, lang_vararg__VaList);
