...
struct _io_Reader__ReaderClass {
    ...
    lang_types__SizeT (*read)(io_Reader__Reader*, lang_types__Char*, lang_types__Int, lang_types__Int);
    lang_types__Char (*read_char)(io_Reader__Reader*);
    lang_types__String (*readUntil)(io_Reader__Reader*, lang_types__Char);
    void (*skipUntil)(io_Reader__Reader*, lang_types__Char);
    lang_types__String (*readLine)(io_Reader__Reader*);
    void (*skipLine)(io_Reader__Reader*);
    lang_types__Bool (*eachLine)(io_Reader__Reader*, __FUNC___String_Bool);
...
#define Reader_eachLine(_this_, f) io_Reader__Reader_eachLine((void*) (_this_), (void*) (f))
...
#define Reader_hasNext(_this_) io_Reader__Reader_hasNext((void*) (_this_))
