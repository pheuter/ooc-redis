...
lang_types__LLong os_Time__Time_microtime();
lang_types__UInt os_Time__Time_microsec();
lang_types__UInt os_Time__Time_sec();
lang_types__UInt os_Time__Time_min();
lang_types__UInt os_Time__Time_hour();
void os_Time__Time_sleepSec(lang_types__Float duration);
void os_Time__Time_sleepMilli(lang_types__UInt duration);
void os_Time__Time_sleepMicro(lang_types__UInt duration);
...
lang_types__UInt os_Time__Time___getrunTime__();
void os_Time_load();
#if !(defined(__WIN32__) || defined(__WIN64__))
