...
struct _os_Time__TimeClass {
    struct _lang_types__ClassClass __super__;
    lang_types__UInt __time_millisec_base;
    os_Time__Time* (*new)();
    void (*init)(os_Time__Time*);
    lang_types__LLong (*microtime)();
    lang_types__UInt (*microsec)();
    lang_types__UInt (*sec)();
    lang_types__UInt (*min)();
    lang_types__UInt (*hour)();
    void (*sleepSec)(lang_types__Float);
    void (*sleepMilli)(lang_types__UInt);
    void (*sleepMicro)(lang_types__UInt);
    lang_types__UInt (*__getrunTime__)();
};
